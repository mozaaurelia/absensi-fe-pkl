export default function AttendanceHistory() {
  const logs = [
    { date: "Senin, 6 Juli 2026", masuk: "08:56", pulang: "18:03", status: "Hadir", color: "bg-green-100 text-green-700" },
    { date: "Selasa, 7 Juli 2026", masuk: "09:14", pulang: "18:00", status: "Terlambat", color: "bg-amber-100 text-amber-700" },
    { date: "Rabu, 8 Juli 2026", masuk: "--:--", pulang: "--:--", status: "Belum Absen", color: "bg-amber-100 text-amber-700" },
    { date: "Kamis, 9 Juli 2026", masuk: "-", pulang: "-", status: "Terjadwal", color: "bg-gray-100 text-gray-500" },
  ];

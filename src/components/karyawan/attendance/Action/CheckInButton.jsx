...
export default function CheckInButton({ onClick, disabled = false }) {
  ...
  return (
    ...
    >
      <span className="relative w-24 h-24 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white shadow-lg shadow-green-900/20 transition-transform group-hover:scale-105 group-active:scale-95">
        {!disabled && (

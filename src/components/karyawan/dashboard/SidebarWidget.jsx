  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1 mt-auto pt-4 border-t border-white/10">
        <button
          onClick={toggleTheme}
          className={`flex items-center py-2.5 rounded-lg text-sm font-medium text-blue-100/80 hover:bg-white/10 transition-all duration-300 ease-in-out ${
            open ? "px-3 gap-3" : "pl-3.25 gap-0"
          }`}
          title={!open ? (theme === "dark" ? t("sidebar.lightMode") : t("sidebar.darkMode")) : undefined}
        >

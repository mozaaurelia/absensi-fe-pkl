    ...
    <div className="bg-linear-to-r from-[#1E3A5F] to-[#2a4f7a] rounded-2xl px-8 py-6 text-white shadow-lg mb-8">
      <div className="flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button className="hidden md:inline-flex border border-white/25 rounded-lg px-4 py-2 text-sm font-semibold text-white hover:bg-white/10 transition-colors whitespace-nowrap">
            {t("leaveHeader.history")}
          </button>
          <button className="hidden md:inline-flex bg-white text-[#1E3A5F] rounded-lg px-4 py-2 text-sm font-bold hover:bg-blue-50 transition-colors whitespace-nowrap">
